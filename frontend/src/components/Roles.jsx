    ...
    <div>
      <nav className="navbar navbar-expand-lg navbar-dark p-3 shadow-sm" style={{ backgroundColor: '#DB0000' }}>
        <div className="container">
          ...
          <span className="navbar-brand fw-bold">CELUACCEL Gestion de Roles</span>
        ...
        <div className="row">
          <div className="col-md-4 mb-4">
            <div className="card p-3 shadow-sm border-0">
              ...
              <input className="form-control mb-2" type="number" disabled={enEdicion} value={form.Codigo_Rol} placeholder="Código Rol" onChange={e => setForm({...form, Codigo_Rol: e.target.value})} />
              <input className="form-control mb-3" value={form.Descripcion_Rol} placeholder="Descripción" onChange={e => setForm({...form, Descripcion_Rol: e.target.value})} />
                  ...
                  {datos.map(d => (
                    <tr key={d.Codigo_Rol}>
                      ...
                      <td>
                        ...
                        <button className="btn btn-sm text-white fw-bold" style={{ backgroundColor: '#DB0000' }} onClick={() => eliminar(d.Codigo_Rol)}>Borrar</button>
                      </td>
                    </tr>
                  ))}
                </tbody>
